...
enum StripboardField: String, CaseIterable, Identifiable {
    ...
    func displayValue(for scene: Scene) -> String {
        ...
        case .props:            return scene.props.joined(separator: ", ")
        ...
        case .specialEquipment: return scene.specialEquipment.joined(separator: ", ")
        case .stunts:           return scene.stunts.joined(separator: ", ")
        case .sfx:              return scene.sfx.joined(separator: ", ")
