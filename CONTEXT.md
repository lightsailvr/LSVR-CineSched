...
ProductionEdits.swift     The production-wide edits (character rename, lock, unlock) as pure ProjectData
                          mutations the phone calls; ContentView keeps its own copies (ProductionEditsTests).
...
BreakdownBrowser.swift    The Breakdown Browser's script-ordered scene ids and stepping (pure, #28; a second copy of
                          the Mac's order).
